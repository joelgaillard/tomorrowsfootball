      ...
      <div class="flex flex-col-reverse gap-6 md:flex-row">
        ...
        <div class="flex flex-col gap-8 justify-center md:w-1/2">
          ...
          <p class="text-2xl">
            ...
            a women’s football coach in Switzerland.
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="flex flex-col-reverse gap-6 md:flex-row">
        ...
        <div class="flex flex-col gap-8 justify-center md:w-1/2">
          ...
          <div class="text-2xl">
            ...
            <p>
              This is the first official step towards becoming a certified coach
              in Switzerland.
            </p>
            <ul class="list-disc pl-4">
            ...
            <p>
              After completing the course, you’ll receive your C License,
