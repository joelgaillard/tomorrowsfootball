  ...
  <form @submit.prevent="submitForm">
    <div class="flex flex-col gap-16">
      ...
      <div class="flex flex-col gap-8">
        <div class="text-5xl text-secondary">Answer the question to enter the prize draw.</div>
        <div class="text-5xl">Good luck!</div>
        <div class="text-5xl font-bold">What is the name of Sarah’s best friend?</div>

        <fieldset class="form-control flex flex-col gap-8">
          <label class="label cursor-pointer gap-4 text-secondary-content">
            <input type="radio" name="answer" value="Nicky" v-model="form.answer" class="radio radio-xl" />
            <span class="label-text text-5xl text-secondary-content">Nicky</span>
          </label>
          <label class="label cursor-pointer gap-4 text-secondary-content">
            <input type="radio" name="answer" value="Lea" v-model="form.answer" class="radio radio-xl" />
            <span class="label-text text-5xl text-secondary-content">Lea</span>
          </label>
          <label class="label cursor-pointer gap-4 text-secondary-content">
            <input type="radio" name="answer" value="Robin" v-model="form.answer" class="radio radio-xl" />
            <span class="label-text text-5xl text-secondary-content">Robin</span>
          </label>
        </fieldset>
      ...
      <div class="flex flex-col gap-9">
        ...
        <div class="flex flex-col gap-9 md:flex-row md:gap-4">
          <BaseInput
      ...
      <div class="flex flex-col gap-9">
        ...
        <BaseDropdown
          ...
          label="Would you like to be contacted to discuss it?"
          :options="[
